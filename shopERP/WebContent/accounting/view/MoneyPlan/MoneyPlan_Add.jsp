			...
			<div class="contents contents-fixed" style="top: 29px; bottom: 34px">
				...
				<table
					...
					<tbody>
							...
							<td>
								<div class="radio-inline">
									<label> <input id="optionsRadios1" type="radio"
										checked="" value="출금" name="typelist">출금
									</label>
								</div>
								<div class="radio-inline">
									<label> <input id="optionsRadios2" type="radio"
										value="입금" name="typelist">입금
									</label>
								</div>
							</td>
						</tr>
						<tr id="row-CardTYPE">
							<th>발생단위</th>
							<td><select class="form-control" name="funds_id">
									<option>1개월마다</option>
									<option>2개월마다</option>
									<option>3개월마다</option>
									<option>4개월마다</option>
						...
						<tr id="row-firstStart">
							<th>최초 발생날짜</th>
							<td><select id="yy" onfocus="nextfield ='mm';" name="repeat_unit">
							...
							</select> <select id="mm" onfocus="nextfield ='dd';" name="repeat_unit">
								...
								size="5" value="26" maxlength="3" name="repeat_unit"></td>
						</tr>

						<tr>
							<th>발생기간</th>
							<td><select id="e_yy" onfocus="nextfield ='e_mm';"
								name="period">
									<option selected="selected">2016</option>
									<option>2017</option>
									<option>2018</option>
							</select> <select id="e_mm" onfocus="nextfield ='dd';" name="period">
									<option value="01">1월</option>
									<option value="02">2월</option>
									<option value="03">3월</option>
									<option value="04" selected="selected">4월</option>
