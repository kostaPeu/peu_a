	...
	<div class="wrapper-erp-local-nav">
		...
		<div class="erp-local-nav">
			<ul class="local">
				...
				<li data-target="#one" data-toggle="collapse"><a
					href="">회계기초등록</a>
					<ul id="one" class="collapse">
						<li><a href="./mainTest2.jsp?left=./accounting/view/Accounleft2.jsp&contents=./accounting/view/card.jsp">기초잔액등록</a></li>
				...
				<li data-target="#two" data-toggle="collapse"><a>현금거래관리</a>
