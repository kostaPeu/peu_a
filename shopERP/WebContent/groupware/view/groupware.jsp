	...
	<div class="wrapper-erp-local-nav">
		...
		<div class="erp-local-nav">
			<ul class="local">
				...
				<li data-toggle="collapse" href="#dep_project"><a href="./mainTest2.jsp?left=./groupware/view/groupware.jsp&contents=./groupware/view/projectboard/pb_allproject_list.jsp">프로젝트게시판</a>
					<ul id="dep_project" class="collapse">
						<li><a href="./mainTest2.jsp?left=./groupware/view/groupware.jsp&contents=./groupware/view/projectboard/pb_allproject_list.jsp">전체 프로젝트</a></li>
