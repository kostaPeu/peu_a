...
<body>
	...
	<table class="table table-hover">
		...
		<tbody>
			<tr class="row">
				...
				<td class="col-sm-6"><a href="./main.jsp?left=./groupware/view/groupware.jsp&contents=./groupware/view/depboard/dep_board_view.jsp">라면을 먹자</a></td>
	...
	<div class="row">
		<a href="./main.jsp?left=./groupware/view/groupware.jsp&contents=./groupware/view/depboard/dep_board_write.jsp"
