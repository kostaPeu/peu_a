...
<body id="body_html" class="font-dotum">
	...
	<div id="Top-Menu" class="wrapper-erp-global-nav">
		...
		<div class="erp-global-nav">
			<ul>
				<li class=""><a id="TopMainMenu1" href="./mainTest2.jsp?left=./basic/view/basic.jsp">기초관리</a>
				<li class=""><a id="TopMainMenu2" href="./mainTest2.jsp?left=./purchase/view/purchase.jsp">구매관리</a></li>
				<li class=""><a id="TopMainMenu3" href="./mainTest2.jsp?left=./sale/view/sale.jsp">판매관리</a></li>
				<li class=""><a id="TopMainMenu4" href="./mainTest2.jsp?left=./odm/view/odm.jsp">주문/배송관리</a></li>
				<li class=""><a id="TopMainMenu5" href="./mainTest2.jsp?left=./stock/view/stock.jsp">재고관리</a></li>
				<li class=""><a id="TopMainMenu6" href="./mainTest2.jsp?left=./accounting/view/Accounleft.jsp">회계관리</a></li>
